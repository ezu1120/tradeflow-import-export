...
export default function TrustBar() {
  const certifications = [
    ...
    { name: "AEO Certified", icon: Shield },
    { name: "IATA Member", icon: Globe },
    { name: "C-TPAT Verified", icon: CheckCircle2 },
    { name: "5-Star Rating", icon: Star },
    { name: "FMC Licensed", icon: Truck },
  ];
    ...
    <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900 border-b border-slate-700 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.05]">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23D4AF37' fill-opacity='1'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            Certified & Compliant Across All Major Trade Corridors
          </h2>
          ...
          {certifications.map((cert, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-sm font-semibold text-slate-300 text-center leading-tight group-hover:text-white transition-colors duration-300">
                  {cert.name}
                </span>
              </motion.div>
            );
        ...
        >
          <div className="bg-slate-700/30 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-slate-600/50 shadow-2xl">
            <p className="text-slate-200 text-lg leading-relaxed">
              Our certifications ensure your cargo moves safely, legally, and efficiently through 
              every checkpoint, customs office, and border crossing worldwide.
            </p>
          </div>
        </motion.div>
      </div>

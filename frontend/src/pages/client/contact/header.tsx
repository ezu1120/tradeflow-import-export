...
const bgImage = "https://images.unsplash.com/photo-1423666639041-f56000c27a9a?q=80&w=2074&auto=format&fit=crop";
    ...
    <div className="relative h-[400px] md:h-[500px] w-full flex justify-center items-center overflow-hidden"
      ...
      <div className="relative flex flex-col text-center px-4 sm:px-8 md:px-16 max-w-5xl z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
          ...
          <span className="text-sm font-medium text-[#D4AF37] uppercase tracking-wider">{settings.contact_page_badge}</span>
        </motion.div>
        <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}
          className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight">
          {settings.contact_page_title.split(' ').map((word, i, arr) =>

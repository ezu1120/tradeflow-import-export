...
function SectionSettings() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-base font-semibold text-white">Services Page Settings</h3>
      ...
      <div className="bg-slate-900/40 border border-slate-700/50 rounded-xl p-4">
        <p className="text-xs text-slate-500 uppercase tracking-wider mb-3">Services Page Header</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
...
export default function ServicesAdminPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <h2 className="text-2xl font-bold text-white">Services Page</h2>
